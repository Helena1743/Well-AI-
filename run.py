...
try: 
    cardio_model = joblib.load("model_cardio_health.joblib") 
    diabetes_model = joblib.load('model_diabetes_health.joblib') 
    stroke_model = joblib.load("model_stroke_health.joblib") 
